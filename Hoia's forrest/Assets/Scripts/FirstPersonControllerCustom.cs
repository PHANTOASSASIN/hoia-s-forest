...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonControllerCustom : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip[] m_RunningSounds;
        ...
        {
            int n = Random.Range(1, m_RunningSounds.Length);
            m_AudioSource.clip = m_RunningSounds[n];
            m_AudioSource.PlayOneShot(m_AudioSource.clip);
            m_RunningSounds[n] = m_RunningSounds[0];
            m_RunningSounds[0] = m_AudioSource.clip;
